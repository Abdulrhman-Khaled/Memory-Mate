...
class ScoreBoard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Row(
      ...
      children: [
        Score(label: 'النتيجة', score: '$score'),
        const SizedBox(
          width: 8.0,
        ),
        Score(
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(children: [
        Text(
          label.toUpperCase(),
          style: const TextStyle(fontSize: 18.0, color: AppColors.white,fontFamily: 'Boutros'),
        ),
        Text(
          score,
          style: const TextStyle(
              color: AppColors.white, fontWeight: FontWeight.bold, fontSize: 18.0,fontFamily: 'Boutros'),
        )
      ]),
    );
  }
